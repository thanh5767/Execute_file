no_stack_item = ['wood_sword','wood_pickaxe','wood_axe','spear','bow']
...
weapon_type = ['wood_sword','wood_axe','wood_pickaxe','bow','spear']
block_list = ('stone','solid_stone','wood_block','fence_stake','chest','rock')
